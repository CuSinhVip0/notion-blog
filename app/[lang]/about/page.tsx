    ...
    return (
        <>
            ...
            >
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-purple-100/80 via-white to-cyan-100/80 dark:from-purple-900/20 dark:via-neutral-950 dark:to-cyan-900/20">
                    <FloatingBlob
                        className="w-96 h-96 bg-purple-500/20 dark:bg-purple-500/30 rounded-full blur-3xl"
                        initialTop="20%"
                        initialLeft="10%"
                    />
                    <FloatingBlob
                        className="w-96 h-96 bg-cyan-500/20 dark:bg-cyan-500/30 rounded-full blur-3xl"
                        initialTop="60%"
                        initialLeft="60%"
                    />
                </div>
                ...
                {/* Grid pattern */}
                <div className="absolute inset-0 bg-[linear-gradient(rgba(0,0,0,0.04)_1px,transparent_1px),linear-gradient(90deg,rgba(0,0,0,0.04)_1px,transparent_1px)] dark:bg-[linear-gradient(rgba(255,255,255,0.03)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.03)_1px,transparent_1px)] bg-[size:50px_50px]" />
                ...
                <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    >
                        ...
                        <DisplayName hiIm={t("hiIm")} />

                        <CurrentRole roles={roles} />
                        ...
                        <p className="text-lg sm:text-xl text-neutral-500 dark:text-neutral-400 max-w-2xl mx-auto mb-12">
                            {t("bio")}
                        </p>
                        ...
                        <div className="flex flex-wrap justify-center gap-4 mb-12">
                            <motion.a
                                ...
                                whileTap={{ scale: 0.95 }}
                                className="px-8 py-4 bg-gradient-to-r from-cyan-500 to-purple-500 text-white rounded-lg font-semibold hover:shadow-lg hover:shadow-purple-500/50 transition-shadow"
                            >
                                {t("getInTouchBtn")}
                            </motion.a>
                            <motion.a
